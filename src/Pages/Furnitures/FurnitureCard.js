      ...
      <div className=' rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100'>
        <PhotoProvider>
          <PhotoView src={picture}>
            <img
              title='Click for View full Image'
              src={picture}
              alt=''
        ...
        <div className='sm:text-[13px] text-[12px] flex flex-col gap-1 mt-2 font-semibold'>
          <div className='flex px-2 justify-between'>
            ...
            <p>
              ReSalePrice: <span className='font-semibold'>${reSalePrice}</span>
            </p>
          </div>
          <div className='flex px-2 justify-between'>
            ...
            <p>
              Uses of:{' '}
              <span className='text-secondary font-bold'> {years_of_use}</span>
              {years_of_use > 1 ? 'years' : 'year'}{' '}
            </p>
          </div>
          <div className='flex px-2 justify-between'>
          ...
          <figcaption className='flex items-center  pl-4 space-x-2'>
            ...
            <div className='font-medium dark:text-white text-left'>
              ...
              <div className='  flex items-center   text-gray-500 dark:text-gray-400'>
                {' '}
                <GoLocation title='Location' className='mt-1 ' />{' '}
                <span title='Location'>{location} </span>{' '}
              </div>
            </div>
          </figcaption>
          <div className='flex gap-1 pb-1 pl-4'>
            <FiClock title='Published Date' className='mt-1 text-gray-500 ' />{' '}
            <span
        ...
        <div className='p-3 pt-4 justify-between items-center flex'>
          ...
          <p>
            <label
              onClick={() => setSelectOrder(furniture)}
              htmlFor='orderModal'
