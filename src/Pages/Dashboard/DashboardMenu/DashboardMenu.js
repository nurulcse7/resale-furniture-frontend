...
import { FaDatabase, FaPlus, FaRegHourglass, FaUsers } from 'react-icons/fa';
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ...
                    : 'flex items-center px-4 py-2 mt-1 text-gray-600 transition-colors duration-300 transform  hover:bg-white hover:text-gray-700'
                }
              >
                <FaRegHourglass />
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ...
                    : 'flex items-center px-4 py-2 mt-4 text-gray-600 transition-colors duration-300 transform  hover:bg-white hover:text-gray-700'
                }
              >
                <FaRegHourglass />
                <span className='mx-4 font-medium'>My Orders </span>
