    ...
    fetch(
      ...
      .then((img) => {
        if (img.success) {
          ...
          axios
            .post(`${process.env.REACT_APP_ApiUrl}furnitures`, {
      ...
      <section className='max-w-4xl p-6   rounded-md shadow-md'>
        ...
        <form onSubmit={handleSubmit(handleAddProduct)}>
          <div className='grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2'>
            ...
            <div>
              <label className='' htmlFor='originalPrice'>
                Original Price
              </label>
              <input
                id='originalPrice'
            ...
            <div>
              <label className='' htmlFor='reSalePrice'>
                ReSale Price
              </label>
              <input
                id='reSalePrice'
          ...
          <div className='flex justify-end mt-6'>
            <button className='px-6 py-2 leading-5  transition-colors duration-200 transhtmlForm bg-pink-500 rounded-md hover:bg-pink-700 focus:outline-none focus:bg-gray-600'>
              {' '}
              Save
            </button>
          </div>
